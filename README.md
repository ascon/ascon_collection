...
| **Web interface (JavaScript)** | [motarekk.github.io](https://motarekk.github.io/) | Mohamed Tarek | NIST SP 800-232 draft | `playascon` is an interactive website that encrypts/hashes any user-provided data using a JavaScript implementation (all Ascon family members) |
